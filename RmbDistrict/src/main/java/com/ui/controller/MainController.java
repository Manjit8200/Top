...
public class MainController {
	 ...
	 * 
	 * @Autowired ServiceProjectDAO serviceprojectdao;
	 * 
	...
	public String front_home(Locale locale, Model model, HttpSession session, HttpServletRequest request) {
	...
	public String login(String r, Locale locale, Model model, HttpSession session) {
	...
	public String login_member(int eid, Locale locale, Model model, HttpSession session) {
	 ...
	 * public String business_categories(Locale locale, Model model, HttpSession
	...
	public String my_profile(Locale locale, Model model, HttpSession session) {
	...
	public String manage_my_profile(Locale locale, Model model, HttpSession session) {
	...
	public String award(Locale locale, Model model, HttpSession session) {
		logger.info("Welcome Award");		
		return "award";
	}
	
	@RequestMapping(value = "award_detail", method = RequestMethod.GET)
	public String award_detail(int awardid, Locale locale, Model model, HttpSession session)
	{
		logger.info("Welcome to Award Detail", locale);		
		return "award_detail";
	}	
	@RequestMapping(value = "/service_projects", method = RequestMethod.GET)
	public String service_projects(Locale locale, Model model, HttpSession session) {
		logger.info("Welcome Service Projects");
		
		return "service_projects";
	}
	
	@RequestMapping(value = "/birthdays_and_anniversaries", method = RequestMethod.GET)
	public String birthdays_and_anniversaries(Locale locale, Model model, HttpSession session) {
	...
	public String service_project_detail(int id, Locale locale, Model model, HttpSession session)
	{
		logger.info("Welcome to Service Project Detail", locale);
		
		model.addAttribute("AlbumByServiceProjectId", albumdao.getPhotoAlbumByServiceProjectId(id));
		model.addAttribute("ServiceProjectImages", serviceprojectdao.getRelatedServiceProjectImages(id));
		model.addAttribute("albumImages", albumdao.getAllAlbumImages());		
	...
	@RequestMapping(value = "/join_leaders", method = RequestMethod.GET)
	public String join_leaders(Locale locale, Model model, HttpSession session) {
		logger.info("Welcome join_leaders");
		
		return "join_leaders";
	}
	
	@RequestMapping(value = "/exchange_ideas", method = RequestMethod.GET)
	public String exchange_ideas(Locale locale, Model model, HttpSession session) {
		logger.info("Welcome exchange_ideas");
		
		return "exchange_ideas";
	}
	
	@RequestMapping(value = "/take_action", method = RequestMethod.GET)
	public String take_action(Locale locale, Model model, HttpSession session) {
	...
	public String give(Locale locale, Model model, HttpSession session) {
	...
	public String become_a_member(Locale locale, Model model, HttpSession session) {
		logger.info("Welcome become_a_member");
		
		return "become_a_member";
	}
	
	@RequestMapping(value = "/committee", method = RequestMethod.GET)
	public String committee(Locale locale, Model model, HttpSession session) {
	...
	public String golf_tournament(Locale locale, Model model, HttpSession session) {
		logger.info("Welcome golf tournament");
	...
	@RequestMapping(value = "/manage_my_contact_detail", method = RequestMethod.GET)
	public String manage_my_contact_detail(Locale locale, Model model, HttpSession session) {
		logger.info("Welcome Manage My Contact Detail");		
			
		return "manage_my_contact_detail";
	}
	
	@RequestMapping(value = "/manage_my_family_detail", method = RequestMethod.GET)
	public String manage_my_family_detail(Locale locale, Model model, HttpSession session) {
		logger.info("Welcome Manage My Family Detail");	
			
		return "manage_my_family_detail";
	}
	
	@RequestMapping(value = "/my_sponsor", method = RequestMethod.GET)
	public String my_sponsor(Locale locale, Model model, HttpSession session) {
	...
	public String members_family_info(int membersfamilyid, int memberid, Locale locale, Model model, HttpSession session)
	{
		logger.info("Welcome to Members's Family Info", locale);		
		return "members_family_info";
	}
	
	@RequestMapping(value = "contact", method = RequestMethod.GET)
	public String contact(Locale locale, Model model, HttpSession session)
	{
		logger.info("Welcome to Contact Us", locale);		
		return "contact";
	}*/
	...
	public String contact_detail(int membercategoryid, String tenureplan, Locale locale , Model model, HttpSession session)
	{
