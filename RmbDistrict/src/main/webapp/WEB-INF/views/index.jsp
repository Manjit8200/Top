...
<link rel="stylesheet" href="resources/front/css/slick.css">
<link rel="stylesheet" href="resources/front/css/animate.css">
<link rel="stylesheet" href="resources/front/css/nice-select.css">
<link rel="stylesheet" href="resources/front/css/jquery.nice-number.min.css">
<link rel="stylesheet" href="resources/front/css/magnific-popup.css">
<link rel="stylesheet" href="resources/front/css/bootstrap.min.css">
<link rel="stylesheet" href="resources/front/css/font-awesome.min.css">
<link rel="stylesheet" href="resources/front/css/default.css">
<link rel="stylesheet" href="resources/front/css/style.css">
<link rel="stylesheet" href="resources/front/css/responsive.css">
...
<div class="col-lg-4">
<!--<div class="header-social text-lg-right text-right">
<ul>
...
<li><span><a href="#"><i class="fa fa-user-circle-o"></i> </a></span></li>
...
<img src="resources/front/images/Logo-RMB.png" alt="Logo">
</a>
</div>
...
<div class="single-slider bg_cover pt-150" style="background-image: url(resources/front/images/slider/s-3.jpg)">
</div> <!-- single slider -->
...
<div class="singel-teachers1 mt-30 text-center">
<div class="image">
<img src="resources/front/images/rtn-parag-doshi.jpg" alt="Rtn. Parag Doshi">
</div>
<div class="cont">
...
<!--<div class="link-btn">
<a href="#">
Join With Us <i class="fa fa-long-arrow-right"></i></a>
</div>-->
...
<!--====== jquery js ======-->
<script src="resources/front/js/vendor/modernizr-3.6.0.min.js"></script>
<script src="resources/front/js/vendor/jquery-1.12.4.min.js"></script>

<!--====== Bootstrap js ======-->
<script src="resources/front/js/bootstrap.min.js"></script>

<!--====== Slick js ======-->
<script src="resources/front/js/slick.min.js"></script>

<!--====== Magnific Popup js ======-->
<script src="resources/front/js/jquery.magnific-popup.min.js"></script>

<!--====== Counter Up js ======-->
<script src="resources/front/js/waypoints.min.js"></script>
<script src="resources/front/js/jquery.counterup.min.js"></script>

<!--====== Nice Select js ======-->
<script src="resources/front/js/jquery.nice-select.min.js"></script>

<!--====== Nice Number js ======-->
<script src="resources/front/js/jquery.nice-number.min.js"></script>

<!--====== Count Down js ======-->
<script src="resources/front/js/jquery.countdown.min.js"></script>

<!--====== Validator js ======-->
<script src="resources/front/js/validator.min.js"></script>

<!--====== Ajax Contact js ======-->
<script src="resources/front/js/ajax-contact.js"></script>
