										...
										<div class="panel-heading" style="border-top: 2px solid blue; background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #e2e2e2), color-stop(1, #fafafa));">
											<div class="row" style="color: #333;">
												...
												<div class="col-md-5 text-center">
													 <h3><span class="glyphicon glyphicon-user"></span> Manage Members</h3>													
												</div>
												<div class="col-md-3">
												...
												<table class="table table-bordered">
													<tbody >
														<tr style="color:black">
															...
															<th style="color:black" width="12%">MEMBERSHIP #</th>
														...
														<tr ng-repeat="item in getmember1" style="cursor:pointer;cursor:hand">
															...
															<td style="color:black;" ng-click='redirectmemberdetail(item.memberId)'>{{item.memberAddress1}}, {{item.memberAddress2}}, {{item.memberAddress3}}, {{item.memberCityName}}</td>
															<td style="color:black;" ng-click='redirectmemberdetail(item.memberId)'>{{item.memberMobileNumber}}</td>
